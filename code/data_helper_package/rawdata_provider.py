...
'''
#项目根目录
path = "/Users/admin/Documents/测井/LogMethod-master2.0/data" #os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
print("path:"+path)
class RawDataProvider:
    #数据的目录
    data_dir=path #os.path.join(path,'/data')
    #数据目录的文件列表
